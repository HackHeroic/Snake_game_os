...
GAME_SRC = src/game/snake.c src/game/food.c src/game/board.c src/game/score.c src/game/obstacles.c src/game/stats.c src/game/ghost.c src/game/powerups.c src/game/replay.c
