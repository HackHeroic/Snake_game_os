...
static const Theme themes[4] = {
    /* Classic */
    { 46, {46, 40, 34, 28, 22}, 196, 226, 39, 250, 45, 201, 92, 0 },
    /* Ice */
    { 45, {45, 39, 33, 27, 21}, 226, 214, 195, 255, 75, 93, 109, 0 },
    /* Lava */
    { 202, {202, 196, 160, 124, 88}, 46, 226, 33, 250, 208, 129, 162, 0 },
    /* Rainbow */
    { 196, {196, 208, 226, 46, 21}, 255, 226, 39, 250, 45, 201, 213, 1 }
};
